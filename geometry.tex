...
Die darzustellende Geometrie kann extrem unterschiedliche Dimensionen haben. Trotzdem soll nach dem Laden der Szene die Kamera so positioniert sein, das ein Überblick über die gesamte Szene möglich ist.
...
Das Baum- bzw. Busch-Model wird mittels des Loaders aus der Datei geladen und geparst. Danach steht es als normales 3D-Objekt zur Verfügung und kann skaliert und positioniert werden. Um die Ladezeit gering zu halten wurde die Modelle mit sehr wenigen Vertices angelegt und mit einfachen Texturen versehen. Die Dateigröße des Baum-Models mit Grafiktextur beträgt etwa 50 Kilobytes. Komplexere Modelle könnten mehrere Megabytes groß sein und das Nachladen über die Internetverbindung würde zu lange dauern.
...
Die Grundebene+Gitternetz

JSON-Schema für Settings, geometryData, animationData,...

WebGL natives koordinaten System
